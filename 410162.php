...
$query="SELECT * FROM page WHERE name='410162'"; // change for every page  & change it on form action below
	$result=mysqli_query($dbc,$query);
	$row=mysqli_fetch_array($result);
	$n=$n+$row['view'];
	$p=$row['point'];
		$query2="UPDATE page SET view=$n WHERE name='410162'"; // change for every page
			$result2=mysqli_query($dbc,$query2);
			$query3="SELECT fname,lname,email,path FROM comment WHERE name='410162'"; // change for every page
...
<font color="red"><b>लड़के को हुआ लड़की से प्यार, कुत्ता बना बीच की दीवार</b></font><br>
<b>बेंगलुरु:</b>  बेंगलुरु की एक युवती को अपना कुत्ता इतना प्यारा है कि उसने एक भावी दूल्हे को सिर्फ इसलिए खारिज कर दिया, क्योंकि लड़के को युवती के कुत्ते को लेकर कुछ समस्या थी.
...
<img src="snap.jpg" width="300" height="300"><br>
...
<input type="hidden" name="page" id="page" value="410162">
...
?>
<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.newsktm.com/410162.php" style="background:blue; color:white; font-size:18px;" target="_blank"><font bgcolor="green">Share on Facebook</font></a></i>
