...
<div id="left">
<form name="aform" action="login2.php" method="POST" onSubmit="return validate()">
...
<tr><td colspan="2" align="center"><input type="submit" value="Login" style="background:red; color:white;"></td></tr></table>
</form>
<br><br>
